...
if(isset($_POST["titulo"]) && isset($_POST["descripcion"]) && isset($_FILES["imagen"])){
    $banner->subirNuevoBanner($_POST["titulo"], $_POST["descripcion"], $_FILES["imagen"]);
                ...
                <div class="container">
                    <form action="agregarBanner.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="input-group mb-3">
                            <input type="text" require name="titulo" class="form-control"
                                aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default"
                                placeholder="Titulo">
                        </div>

                        <div class="input-group mb-3">
                            <input type="text" require name="descripcion" class="form-control"
                                aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default"
