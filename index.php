            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    <li class="nav-item active">
                        <a class="nav-link" href="index.html">Bella Sulamita<span class="sr-only">(current)</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="primavera.html">Primavera - Verano</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="ubicación.html">Ubicación</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link fa fa-user-circle fa-2x" href="login.html"></a>
                    </li>
                    <li class="nav-item">
                        ...
                        <div class="card border-0 text-white text-center">
                            ...
                            <div class="card-img-overlay d-flex align-items-center">
                                <div class="w-100 py-3">
                                    ...
                                    <a href="jeans.html" class="btn btn-light">Ver</a>
                                </div>
                            </div>
                        </div>
                    </div>
